 ...
 *
 * 具体接入文档请参考：https://docs.open.alipay.com/
 */
...
public class FastPay implements View.OnClickListener {
    ...
    private FastPay(DsDelegate delegate) {
        this.mActivity = delegate.getProxyActivity();
        this.mDialog = new AlertDialog.Builder(delegate.getContext()).create();
    }

    public static FastPay create(DsDelegate delegate) {
    ...
    private void weChatPay(int orderId) {
        ...
        DsLogger.d("WX_PAY", weChatPrePayUrl);

        final IWXAPI iwxapi = DsWeChat.getInstance().getWXAPI();
        final String appId = Ds.getConfiguration(ConfigKeys.WE_CHAT_APP_ID);
