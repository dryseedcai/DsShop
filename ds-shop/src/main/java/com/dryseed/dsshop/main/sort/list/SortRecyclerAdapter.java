...
import com.dryseed.ds.ui.recycler.ItemType;
...
public class SortRecyclerAdapter extends MultipleRecyclerAdapter {
    ...
    protected SortRecyclerAdapter(List<MultipleItemEntity> data, DsDelegate delegate) {
        super(data);
    ...
    private void switchContent(ContentDelegate delegate) {
        final DsDelegate contentDelegate = DELEGATE.findChildFragment(ContentDelegate.class);
