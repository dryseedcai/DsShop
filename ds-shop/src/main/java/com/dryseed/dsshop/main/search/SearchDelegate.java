...
public class SearchDelegate extends DsDelegate {
    ...
    private void saveItem(String item) {
        if (!StringUtils.isEmpty(item) && !StringUtils.isSpace(item)) {
            List<String> history;
            final String historyStr = DsPreference.getCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY);
            ...
            DsPreference.addCustomAppProfile(SearchDataConverter.TAG_SEARCH_HISTORY, json);
        }
    }
